...
' This file implements the code-behind class for EditDocTree.aspx.
' EditDocTree.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditDocTree
        Inherits BaseApplicationPage
' Code-behind class for the EditDocTree page.
...
#Region "Section 1: Place your customizations here."
        ...
        Public Sub s_Vis()
            ...
            Dim myDocTypeID As String = Me.DocTreeRecordControl.DocTypeID.Text
            If myDocTypeID = "2511" Then
                Me.DocTreeRecordControl.RequiredCB.Checked = True
            End If
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim myDocType As Boolean = Me.DocTreeRecordControl.RequiredCB.Checked
            Dim myDocTypeID As String

            If myDocType = True Then
                myDocTypeID = "2511"
            Else
                myDocTypeID = "2513"
            End If

            Me.DocTreeRecordControl.DocTypeID.Text = myDocTypeID
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents AlwaysShow As System.Web.UI.WebControls.CheckBox
        Public WithEvents AlwaysShowLabel As System.Web.UI.WebControls.Literal
        Public WithEvents CancelButton As ThemeButton
        Public WithEvents DocNameLabel As System.Web.UI.WebControls.Literal
        Public WithEvents DocTreeRecordControl As FASTPORT.UI.Controls.EditDocTree.DocTreeRecordControl
        ...
        Public WithEvents OnApp As System.Web.UI.WebControls.CheckBox
        Public WithEvents OnAppLabel As System.Web.UI.WebControls.Literal
        Public WithEvents OneActiveCopy As System.Web.UI.WebControls.CheckBox
        Public WithEvents OneActiveCopyLabel As System.Web.UI.WebControls.Literal
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents RecordDocDetails As System.Web.UI.WebControls.CheckBox
        Public WithEvents RecordDocDetailsLabel As System.Web.UI.WebControls.Literal
        Public WithEvents RequiredCB As System.Web.UI.WebControls.CheckBox
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Document Tree"
        End Sub
