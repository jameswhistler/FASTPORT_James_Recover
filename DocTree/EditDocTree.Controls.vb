...
' EditDocTree.aspx page.  The Row or RecordControl classes are the 
...
Namespace FASTPORT.UI.Controls.EditDocTree
...
'Public Class DocTreeRolesTableControl
'        Inherits BaseDocTreeRolesTableControl
'
'    ' The BaseDocTreeRolesTableControl class implements the LoadData, DataBind, CreateWhereClause
'    ' and other methods to load and display the data in a table control.
'
'    ' This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
'    ' The DocTreeRolesTableControlRow class offers another place where you can customize
'    ' the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
'
'End Class
'
'Public Class DocTreeRolesTableControlRow
'        Inherits BaseDocTreeRolesTableControlRow
'        ' The BaseDocTreeRolesTableControlRow implements code for a ROW within the
'        ' the DocTreeRolesTableControl table.  The BaseDocTreeRolesTableControlRow implements the DataBind and SaveData methods.
'        ' The loading of data is actually performed by the LoadData method in the base class of DocTreeRolesTableControl.
'
...
' Base class for the DocTreeRecordControl control on the EditDocTree page.
...
Public Class BaseDocTreeRecordControl
        ...
        Protected Overridable Sub Control_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
              ...
              AddHandler Me.DocTypeID.TextChanged, AddressOf DocTypeID_TextChanged
            
              AddHandler Me.RequiredCB.CheckedChanged, AddressOf RequiredCB_CheckedChanged
        ...
        Public Overridable Sub SetDocTypeID()
            ...
            ' Set the DocTypeID TextBox on the webpage with value from the
            ' DocTree database record.

            ' Me.DataSource is the DocTree record retrieved from the database.
            ' Me.DocTypeID is the ASP:TextBox on the webpage.
            ...
            If Me.DataSource IsNot Nothing AndAlso Me.DataSource.DocTypeIDSpecified Then
                ...
                ' The Format method will return the Display Foreign Key As (DFKA) value
                                Dim formattedValue As String = Me.DataSource.DocTypeID.ToString()
            ...
            Else 
                ...
                Me.DocTypeID.Text = DocTreeTable.DocTypeID.DefaultValue		
                End If
        ...
        Public Overridable Sub SetDocTypeIDLabel()
                      ...
                      'Me.DocTypeIDLabel.Text = "Some value"
                    
                  End Sub
                
        Public Overridable Sub SetInstructionsStandard()
                  
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.InstructionsStandard.Text = "Some value"
        ...
        Public Overridable Sub SetRequiredCB()
        ...
        Public Overridable Sub GetDocTypeID()
            ...
            ' Retrieve the value entered by the user on the DocTypeID ASP:TextBox, and
            ' save it into the DocTypeID field in DataSource DocTree record.
            
            ' Custom validation should be performed in Validate, not here.
            
            'Save the value to data source
            Me.DataSource.Parse(Me.DocTypeID.Text, DocTreeTable.DocTypeID)			
        ...
        Public Overridable Sub GetRoleID()
            ...
            ' save it into the RoleID field in DataSource DocTree record.
                        
            ' Custom validation should be performed in Validate, not here.
            
            Me.DataSource.Parse(GetValueSelectedPageRequest(Me.RoleID), DocTreeTable.RoleID)				
        ...
        Dim hasFiltersDocTreeRecordControl As Boolean = False
            ...
            End If
            HttpContext.Current.Session("QueryString in EditDocTree") = recId
        ...
        Protected Overridable Sub Control_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
			...
			Me.Page.Authorize(Ctype(AlwaysShow, Control), "20")
					
			Me.Page.Authorize(Ctype(AlwaysShowLabel, Control), "20")
					
			Me.Page.Authorize(Ctype(OnApp, Control), "20")
					
			Me.Page.Authorize(Ctype(OnAppLabel, Control), "20")
					
			Me.Page.Authorize(Ctype(OneActiveCopy, Control), "20")
					
			Me.Page.Authorize(Ctype(OneActiveCopyLabel, Control), "20")
        ...
        Protected Overridable Sub DocTypeID_TextChanged(ByVal sender As Object, ByVal args As EventArgs)                
                    
              End Sub
            
        Protected Overridable Sub RequiredCB_CheckedChanged(ByVal sender As Object, ByVal args As EventArgs)                
...
#Region "Helper Properties"
        ...
        Public ReadOnly Property DocTypeID() As System.Web.UI.WebControls.TextBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "DocTypeID"), System.Web.UI.WebControls.TextBox)
            End Get
        End Property
        ...
        Public ReadOnly Property InstructionsStandard() As System.Web.UI.WebControls.Literal
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "InstructionsStandard"), System.Web.UI.WebControls.Literal)
            End Get
        End Property
        ...
        Public ReadOnly Property RequiredCB() As System.Web.UI.WebControls.CheckBox
            Get
                Return CType(BaseClasses.Utils.MiscUtils.FindControlRecursively(Me, "RequiredCB"), System.Web.UI.WebControls.CheckBox)
            End Get
        End Property
