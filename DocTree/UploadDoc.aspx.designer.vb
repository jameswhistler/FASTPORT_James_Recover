...
Partial Public Class UploadDoc
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents UploadDocRB As Global.Telerik.Web.UI.RadButton

    '''<summary>
    '''ProcessBarCodesRB control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents ProcessBarCodesRB As Global.Telerik.Web.UI.RadButton
