...
' AddDocTree.aspx page.  The Row or RecordControl classes are the 
...
Namespace FASTPORT.UI.Controls.AddDocTree
...
' Base class for the DocTreeRecordControl control on the AddDocTree page.
...
Public Class BaseDocTreeRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(DocTreeRecord.Copy(recList(0), False), DocTreeRecord)
        ...
        Public Overridable Sub SetCIX()
            ...
            Else 
                ...
                Me.CIX.Text = EvaluateFormula("URL(""CIX"")", Me.DataSource)		
                End If
        ...
        Public Overridable Sub SetFolder()
            ...
            Else
                ...
                If InvariantLCase(EvaluateFormula("", Me.DataSource)).Equals("true") Then
                    Me.Folder.Checked = True
                Else
        ...
        Public Overridable Sub GetCIX()
            ...
            Me.DataSource.Parse(Me.CIX.Text, DocTreeTable.CIX)			
        ...
        Public Overridable Sub GetDocTreeParentID()
            ...
            'Save the value to data source
            Me.DataSource.Parse(Me.DocTreeParentID.Text, DocTreeTable.DocTreeParentID)			
        ...
        Dim hasFiltersDocTreeRecordControl As Boolean = False
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("DocTree")
            ...
            HttpContext.Current.Session("QueryString in AddDocTree") = recId
