...
' This file implements the code-behind class for EditDocTree_Folder.aspx.
' EditDocTree_Folder.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditDocTree_Folder
        Inherits BaseApplicationPage
' Code-behind class for the EditDocTree_Folder page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents DocDescriptionLabel As System.Web.UI.WebControls.Literal
        Public WithEvents DocNameLabel As System.Web.UI.WebControls.Literal
        Public WithEvents DocTreeRecordControl As FASTPORT.UI.Controls.EditDocTree_Folder.DocTreeRecordControl
