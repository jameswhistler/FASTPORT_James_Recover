...
<%@ Register Tagprefix="FASTPORT" Namespace="FASTPORT.UI.Controls.EditDocTree" Assembly="FASTPORT" %>

<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="Selectors" Namespace="FASTPORT" Assembly="FASTPORT" %>

<%@ Page Language="vb" EnableEventValidation="false" AutoEventWireup="false" Codebehind="EditDocTree.aspx.vb" Culture="en-US" MasterPageFile="../Master Pages/Blank.master" Inherits="FASTPORT.UI.EditDocTree" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<asp:Literal runat="server" id="InstructionsStandard" Text="891">	</asp:Literal>
<br /></td></tr></table>
</td></tr><tr><td><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="DocTreeRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0"><tr><td><table><tr><td class="fls"></td><td class="dfv"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="DocTypeID" Columns="14" MaxLength="14" cssclass="field_input" datareadersortby="ItemName Asc" minlistitems="Default" visible="False"></asp:TextBox></td>
<td>
&nbsp;
...
</td></tr><tr><td class="fls" style="vertical-align:top;"><asp:Literal runat="server" id="RoleIDLabel" Text="Only For">	</asp:Literal></td><td class="dfv" style="vertical-align:top;"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="DocTypeIDLabel" Text="Required Doc">	</asp:Literal></td><td class="dfv"><asp:checkbox id="RequiredCB" runat="server"></asp:checkbox></td></tr><tr><td class="fls"><asp:Literal runat="server" id="RecordDocDetailsLabel" Text="Record Document Details">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="RecordDocDetails"></asp:CheckBox> </td></tr><tr><td class="fls"><asp:Literal runat="server" id="OneActiveCopyLabel" Text="One Active Copy">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="OneActiveCopy"></asp:CheckBox></td></tr><tr><td class="fls"><asp:Literal runat="server" id="OnAppLabel" Text="On Application">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="OnApp"></asp:CheckBox></td></tr><tr><td class="fls"><asp:Literal runat="server" id="AlwaysShowLabel" Text="Always Show">	</asp:Literal></td><td class="dfv"><asp:CheckBox runat="server" id="AlwaysShow"></asp:CheckBox></td></tr></table>
