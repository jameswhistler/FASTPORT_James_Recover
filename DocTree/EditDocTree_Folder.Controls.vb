...
' EditDocTree_Folder.aspx page.  The Row or RecordControl classes are the 
...
Namespace FASTPORT.UI.Controls.EditDocTree_Folder
...
' Base class for the DocTreeRecordControl control on the EditDocTree_Folder page.
...
Public Class BaseDocTreeRecordControl
        ...
        Public Overridable Sub SetDocDescriptionLabel()
                      ...
                      'Me.DocDescriptionLabel.Text = "Some value"
        ...
        Public Overridable Sub SetDocNameLabel()
                      ...
                      'Code for the text property is generated inside the .aspx file.
                      'To override this property you can uncomment the following property and add your own value.
                      'Me.DocNameLabel.Text = "Some value"
        ...
        Dim hasFiltersDocTreeRecordControl As Boolean = False
            ...
            End If
            HttpContext.Current.Session("QueryString in EditDocTree_Folder") = recId
