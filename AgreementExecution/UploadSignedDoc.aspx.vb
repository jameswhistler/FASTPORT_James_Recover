...
' This file implements the code-behind class for UploadSignedDoc.aspx.
' UploadSignedDoc.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class UploadSignedDoc
        Inherits BaseApplicationPage
' Code-behind class for the UploadSignedDoc page.
...
#Region "Ajax Functions"
      ...
      End Sub
        ...
        Public Function s_SaveDoc() As String

            Dim myAgreementExecutionID As String = CustGenClass.f_Decrypt(Me.Page.Request.QueryString("Execution"))
            Dim myReturn As String = Nothing

            Try
                DbUtils.StartTransaction()
                Dim RadUpload1 As Telerik.Web.UI.RadUpload = DirectCast(Me.FindControlRecursively("RadUpload1"), Telerik.Web.UI.RadUpload)
                Dim myUploadCount As Integer = RadUpload1.UploadedFiles.Count
                If myUploadCount > 0 Then
                    For Each file As UploadedFile In RadUpload1.UploadedFiles

                        Dim myFileName As String = file.FileName
                        'Dim bytes() As Byte = BaseApplicationPage.f_UploadedFileToPDFStream(file)

                        Dim myAgreementExecutionRec As AgreementExecutionRecord = AgreementExecutionTable.GetRecord(myAgreementExecutionID, True)
                        'myAgreementExecutionRec.AgreementFilePdf = bytes
                        myAgreementExecutionRec.UseOutsidePdf = True
    ...
    ' Page Event Handlers - buttons, sort, links
		...
		Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
          ...
          ' Customize by adding code before the call or replace the call to the Base function with your own code.
            ...
            Dim myFiledID As String = s_SaveDoc()
		
            SaveButton_Click_Base(sender, args)

            Dim myFiledAsID As String = CustGenClass.f_Decrypt(Me.Page.Request.QueryString("FiledAs"))
						
            'ClientScript.RegisterStartupScript(Page.GetType(), "mykey", "ChildCloseAndRedirect('DocAll," & myFiledID & "," & myFiledAsID & "');", True)
