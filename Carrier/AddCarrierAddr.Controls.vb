...
' AddCarrierAddr.aspx page.  The Row or RecordControl classes are the 
...
Namespace FASTPORT.UI.Controls.AddCarrierAddr
...
' Base class for the PartyAddrRecordControl control on the AddCarrierAddr page.
...
Public Class BasePartyAddrRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(PartyAddrRecord.Copy(recList(0), False), PartyAddrRecord)
        ...
        Dim hasFiltersPartyAddrRecordControl As Boolean = False
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("PartyAddr")
            ...
            HttpContext.Current.Session("QueryString in AddCarrierAddr") = recId
