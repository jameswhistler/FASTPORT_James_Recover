...
' This file implements the code-behind class for AddCarrierAddr.aspx.
' AddCarrierAddr.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddCarrierAddr
        Inherits BaseApplicationPage
' Code-behind class for the AddCarrierAddr page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents PartyAddrRecordControl As FASTPORT.UI.Controls.AddCarrierAddr.PartyAddrRecordControl
    ...
    Try
        ...
        Public Sub SaveButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' redirected to the URL.
                  ...
                  Dim url As String = "../Carrier/EditCarrier.aspx?Party=1&TaxIndex=1"
