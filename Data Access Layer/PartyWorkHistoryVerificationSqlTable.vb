...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyWorkHistoryVerificationTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyWorkHistoryVerificationSqlTable
		Inherits BasePartyWorkHistoryVerificationSqlTable
