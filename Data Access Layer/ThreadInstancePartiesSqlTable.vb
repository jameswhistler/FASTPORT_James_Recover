...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="ThreadInstancePartiesTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class ThreadInstancePartiesSqlTable
		Inherits BaseThreadInstancePartiesSqlTable
