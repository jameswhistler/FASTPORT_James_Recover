...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyWorkHistoryVerificationLogTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyWorkHistoryVerificationLogSqlTable
		Inherits BasePartyWorkHistoryVerificationLogSqlTable
