...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyIncidentTicketedForTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyIncidentTicketedForSqlTable
		Inherits BasePartyIncidentTicketedForSqlTable
