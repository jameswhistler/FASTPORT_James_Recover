...
''' <see cref="CarrierAdGeoTable">FASTPORT.CarrierAdGeoTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="CarrierAdGeoTable"></seealso>

Public Class CarrierAdGeoDefinition

#Region "Definition (XML) for CarrierAdGeoDefinition table"
	'Next 308 lines contain Table Definition (XML) for table "CarrierAdGeoDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="CarrierAdGeoTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>AdGeoID</columnName>")
         tbf.Append(      "<columnUIName>Advertisement Geographical</columnUIName>")
         ...
         tbf.Append(        "<columnFKName>FK_CarrierAdGeo_CarrierAd</columnFKName>")
         ...
         tbf.Append(      "<columnName>AdGeoTypeID</columnName>")
         tbf.Append(      "<columnUIName>Advertisement Geographical Type</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_CarrierAdGeo_Tree</columnFKName>")
         ...
         tbf.Append(      "<columnName>OriginCityID</columnName>")
         tbf.Append(      "<columnUIName>Origin City</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_CarrierAdGeo_GeoCity</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.GeoCityTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         ...
         tbf.Append(      "<columnName>OriginRadius</columnName>")
         tbf.Append(      "<columnUIName>Origin Radius</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         tbf.Append(      "<columnDBDefault>(10)</columnDBDefault>")
         tbf.Append(      "<columnIndex>N</columnIndex>")
         tbf.Append(      "<columnUnique>N</columnUnique>")
         tbf.Append(      "<columnFunction></columnFunction>")
         tbf.Append(      "<columnDBFormat></columnDBFormat>")
         ...
         tbf.Append(      "<columnName>DestRadius</columnName>")
         tbf.Append(      "<columnUIName>Destination Radius</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>AdGeoNotes</columnName>")
         tbf.Append(      "<columnUIName>Advertisement Geographical Notes</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>CarrierAdGeo</TableName>")
         tbf.Append(  "<Version>1</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>CarrierAdGeo</TableCodeName>")
         tbf.Append(  "<TableAliasName>CarrierAdGeo_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTCarrierAdGeo</TableStoredProcPrefix>")
