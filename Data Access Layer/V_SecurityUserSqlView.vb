...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_SecurityUserView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_SecurityUserSqlView
		Inherits BaseV_SecurityUserSqlView
