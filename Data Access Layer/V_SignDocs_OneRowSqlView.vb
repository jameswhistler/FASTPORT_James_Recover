...
''' <summary>
''' Used by the <see cref="V_SignDocs_OneRowView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_SignDocs_OneRowSqlView
	Inherits BaseV_SignDocs_OneRowSqlView
