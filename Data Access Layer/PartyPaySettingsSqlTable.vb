...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyPaySettingsTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyPaySettingsSqlTable
		Inherits BasePartyPaySettingsSqlTable
