...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="CheckInShareTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CheckInShareSqlTable
		Inherits BaseCheckInShareSqlTable
