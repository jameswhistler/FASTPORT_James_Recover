...
''' <see cref="V_FellowUsersView">FASTPORT.V_FellowUsersView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_FellowUsersView"></seealso>

Public Class V_FellowUsersDefinition

#Region "Definition (XML) for V_FellowUsersDefinition table"
	'Next 207 lines contain Table Definition (XML) for table "V_FellowUsersDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_FellowUsersView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>OtherUserID</columnName>")
         tbf.Append(      "<columnUIName>Other User</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>OtherUserName</columnName>")
         tbf.Append(      "<columnUIName>Other User Name</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>1000</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_FellowUsers</TableName>")
         tbf.Append(  "<Version>1</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_FellowUsers</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_FellowUsers_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_FellowUsers</TableStoredProcPrefix>")
