...
''' <see cref="V_AsposeTestView">FASTPORT.V_AsposeTestView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_AsposeTestView"></seealso>

Public Class V_AsposeTestDefinition

#Region "Definition (XML) for V_AsposeTestDefinition table"
	'Next 282 lines contain Table Definition (XML) for table "V_AsposeTestDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_AsposeTestView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>SenderPic</columnName>")
         tbf.Append(      "<columnUIName>Sender Picture</columnUIName>")
         ...
         tbf.Append(      "<columnName>SenderName</columnName>")
         tbf.Append(      "<columnUIName>Sender Name</columnUIName>")
         ...
         tbf.Append(      "<columnName>RecipientName</columnName>")
         tbf.Append(      "<columnUIName>Recipient Name</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>50</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>TestHTML</columnName>")
         tbf.Append(      "<columnUIName>Test HTML</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_AsposeTest</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_AsposeTest</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_AsposeTest_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_AsposeTest</TableStoredProcPrefix>")
