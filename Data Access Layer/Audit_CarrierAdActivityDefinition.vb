...
''' <see cref="Audit_CarrierAdActivityTable">FASTPORT.Audit_CarrierAdActivityTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="Audit_CarrierAdActivityTable"></seealso>

Public Class Audit_CarrierAdActivityDefinition

#Region "Definition (XML) for Audit_CarrierAdActivityDefinition table"
	'Next 721 lines contain Table Definition (XML) for table "Audit_CarrierAdActivityDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="Audit_CarrierAdActivityTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>AdActivityLogID</columnName>")
         tbf.Append(      "<columnUIName>Advertisement Activity Log</columnUIName>")
         ...
         tbf.Append(      "<columnName>PreAdActivityLogID</columnName>")
         tbf.Append(      "<columnUIName>Pre Advertisement Activity Log</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(        "<columnFKName>FK_Audit_CarrierAdActivity_CarrierAdActivity</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.CarrierAdActivityTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>AdActivityID</columnFKColumn>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_Audit_CarrierAdActivity_CarrierAdLink</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Audit_CarrierAdActivity</TableName>")
         tbf.Append(  "<Version>5</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>Audit_CarrierAdActivity</TableCodeName>")
         tbf.Append(  "<TableAliasName>Audit_CarrierAdActivity_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTAudit_CarrierAdActivity</TableStoredProcPrefix>")
