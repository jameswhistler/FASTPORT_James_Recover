...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="AgreementExecutionTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class AgreementExecutionSqlTable
		Inherits BaseAgreementExecutionSqlTable
