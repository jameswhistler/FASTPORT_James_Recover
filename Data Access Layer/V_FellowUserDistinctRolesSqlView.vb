...
''' <summary>
''' Used by the <see cref="V_FellowUserDistinctRolesView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_FellowUserDistinctRolesSqlView
	Inherits BaseV_FellowUserDistinctRolesSqlView
