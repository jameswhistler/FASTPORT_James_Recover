...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="CarrierAdContactsTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CarrierAdContactsSqlTable
		Inherits BaseCarrierAdContactsSqlTable
