...
''' <see cref="V_PartyOrgView">FASTPORT.V_PartyOrgView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_PartyOrgView"></seealso>

Public Class V_PartyOrgDefinition

#Region "Definition (XML) for V_PartyOrgDefinition table"
	'Next 435 lines contain Table Definition (XML) for table "V_PartyOrgDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_PartyOrgView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>PointOfInterest</columnName>")
         tbf.Append(      "<columnUIName>Point Of Interest</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>ContactInfo</columnName>")
         tbf.Append(      "<columnUIName>Contact Information</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>8000</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>Pins</columnName>")
         tbf.Append(      "<columnUIName>Pins</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         ...
         tbf.Append(      "<columnName>PinsSmall</columnName>")
         tbf.Append(      "<columnUIName>Pins Small</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>2000</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>PointStats</columnName>")
         tbf.Append(      "<columnUIName>Point Stats</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>8000</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_PartyOrg</TableName>")
         tbf.Append(  "<Version>3</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_PartyOrg</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_PartyOrg_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_PartyOrg</TableStoredProcPrefix>")
