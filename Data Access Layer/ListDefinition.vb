...
''' <see cref="ListTable">FASTPORT.ListTable</see> class
...
#Region "Definition (XML) for ListDefinition table"
	'Next 207 lines contain Table Definition (XML) for table "ListDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="ListTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>ListID</columnName>")
         tbf.Append(      "<columnUIName>List</columnUIName>")
         ...
         tbf.Append(      "<columnName>ListType</columnName>")
         tbf.Append(      "<columnUIName>List Type</columnUIName>")
         ...
         tbf.Append(      "<columnName>ListName</columnName>")
         tbf.Append(      "<columnUIName>List Name</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>50</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>ListRank</columnName>")
         tbf.Append(      "<columnUIName>List Rank</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>ListValue</columnName>")
         tbf.Append(      "<columnUIName>List Value</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>List</TableName>")
         tbf.Append(  "<Version>2</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>List</TableCodeName>")
         tbf.Append(  "<TableAliasName>List_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTList</TableStoredProcPrefix>")
