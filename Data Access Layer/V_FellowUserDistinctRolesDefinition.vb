...
''' <see cref="V_FellowUserDistinctRolesView">FASTPORT.V_FellowUserDistinctRolesView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_FellowUserDistinctRolesView"></seealso>

Public Class V_FellowUserDistinctRolesDefinition

#Region "Definition (XML) for V_FellowUserDistinctRolesDefinition table"
	'Next 207 lines contain Table Definition (XML) for table "V_FellowUserDistinctRolesDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_FellowUserDistinctRolesView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>ParentPartyID</columnName>")
         tbf.Append(      "<columnUIName>Parent Party</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_FellowUserDistinctRoles</TableName>")
         tbf.Append(  "<Version>2</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_FellowUserDistinctRoles</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_FellowUserDistinctRoles_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_FellowUserDistinctRoles</TableStoredProcPrefix>")
