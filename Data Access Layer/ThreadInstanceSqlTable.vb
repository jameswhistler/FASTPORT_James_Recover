...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="ThreadInstanceTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class ThreadInstanceSqlTable
		Inherits BaseThreadInstanceSqlTable
