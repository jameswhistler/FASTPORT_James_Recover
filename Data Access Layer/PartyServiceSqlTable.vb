...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyServiceTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyServiceSqlTable
		Inherits BasePartyServiceSqlTable
