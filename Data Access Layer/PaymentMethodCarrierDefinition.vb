...
''' <see cref="PaymentMethodCarrierTable">FASTPORT.PaymentMethodCarrierTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="PaymentMethodCarrierTable"></seealso>

Public Class PaymentMethodCarrierDefinition

#Region "Definition (XML) for PaymentMethodCarrierDefinition table"
	'Next 286 lines contain Table Definition (XML) for table "PaymentMethodCarrierDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="PaymentMethodCarrierTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>PaymentMethodCarrierID</columnName>")
         tbf.Append(      "<columnUIName>Payment Method Carrier</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>PaymentMethodCarrier</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>PaymentMethodCarrier</TableCodeName>")
         tbf.Append(  "<TableAliasName>PaymentMethodCarrier_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTPaymentMethodCarrier</TableStoredProcPrefix>")
