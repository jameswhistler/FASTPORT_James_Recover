...
''' <summary>
''' Used by the <see cref="V_PartyUserRolesView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_PartyUserRolesSqlView
	Inherits BaseV_PartyUserRolesSqlView
