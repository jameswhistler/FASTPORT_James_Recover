...
''' <summary>
''' Used by the <see cref="V_AsposeTestChildrenView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_AsposeTestChildrenSqlView
	Inherits BaseV_AsposeTestChildrenSqlView
