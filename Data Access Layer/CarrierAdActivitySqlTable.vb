...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="CarrierAdActivityTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CarrierAdActivitySqlTable
		Inherits BaseCarrierAdActivitySqlTable
