...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="CarrierAdGeoTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CarrierAdGeoSqlTable
		Inherits BaseCarrierAdGeoSqlTable
