...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PaymentMethodTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PaymentMethodSqlTable
		Inherits BasePaymentMethodSqlTable
