...
''' <summary>
''' Used by the <see cref="V_PartyByUserView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_PartyByUserSqlView
	Inherits BaseV_PartyByUserSqlView
