...
''' <see cref="ThreadInstanceTable">FASTPORT.ThreadInstanceTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="ThreadInstanceTable"></seealso>

Public Class ThreadInstanceDefinition

#Region "Definition (XML) for ThreadInstanceDefinition table"
	'Next 477 lines contain Table Definition (XML) for table "ThreadInstanceDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="ThreadInstanceTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>FK_ThreadInstance_Thread</columnFKName>")
         ...
         tbf.Append(      "<columnName>HostID</columnName>")
         tbf.Append(      "<columnUIName>Host</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_ThreadInstance_Party</columnFKName>")
         ...
         tbf.Append(      "<columnName>ResponsibleID</columnName>")
         tbf.Append(      "<columnUIName>Responsible</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_ThreadInstance_Party2</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.PartyTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>PartyID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>Name</columnFKColumnDisplay>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_ThreadInstance_FlowStep</columnFKName>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_ThreadInstance_Tree</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>ThreadInstance</TableName>")
         tbf.Append(  "<Version>10</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>ThreadInstance</TableCodeName>")
         tbf.Append(  "<TableAliasName>ThreadInstance_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTThreadInstance</TableStoredProcPrefix>")
