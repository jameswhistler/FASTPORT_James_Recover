...
''' <see cref="V_SignLicView">FASTPORT.V_SignLicView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_SignLicView"></seealso>

Public Class V_SignLicDefinition

#Region "Definition (XML) for V_SignLicDefinition table"
	'Next 474 lines contain Table Definition (XML) for table "V_SignLicDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_SignLicView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_SignLic</TableName>")
         tbf.Append(  "<Version>2</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_SignLic</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_SignLic_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_SignLic</TableStoredProcPrefix>")
