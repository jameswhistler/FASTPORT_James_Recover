...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_CarrierSimpleView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_CarrierSimpleSqlView
		Inherits BaseV_CarrierSimpleSqlView
