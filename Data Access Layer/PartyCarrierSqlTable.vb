...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyCarrierTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyCarrierSqlTable
		Inherits BasePartyCarrierSqlTable
