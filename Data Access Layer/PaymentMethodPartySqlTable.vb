...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PaymentMethodPartyTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PaymentMethodPartySqlTable
		Inherits BasePaymentMethodPartySqlTable
