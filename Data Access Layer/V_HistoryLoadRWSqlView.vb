...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_HistoryLoadRWView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_HistoryLoadRWSqlView
		Inherits BaseV_HistoryLoadRWSqlView
