...
''' <see cref="PartyRollupTable">FASTPORT.PartyRollupTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="PartyRollupTable"></seealso>

Public Class PartyRollupDefinition

#Region "Definition (XML) for PartyRollupDefinition table"
	'Next 501 lines contain Table Definition (XML) for table "PartyRollupDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="PartyRollupTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>FK_PartyRollup_Party</columnFKName>")
         ...
         tbf.Append(      "<columnName>ChildID</columnName>")
         tbf.Append(      "<columnUIName>Child</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_PartyRollup_Party1</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.PartyTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>PartyID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>Name</columnFKColumnDisplay>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_PartyRollup_FlowStep</columnFKName>")
         ...
         tbf.Append(      "<columnName>DefaultParty</columnName>")
         tbf.Append(      "<columnUIName>Default Party</columnUIName>")
         ...
         tbf.Append(      "<columnName>DefaultSigner</columnName>")
         tbf.Append(      "<columnUIName>Default Signer</columnUIName>")
         tbf.Append(      "<columnType>Boolean</columnType>")
         tbf.Append(      "<columnDBType>bit</columnDBType>")
         tbf.Append(      "<columnLengthSet></columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>PartyRollup</TableName>")
         tbf.Append(  "<Version>4</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>PartyRollup</TableCodeName>")
         tbf.Append(  "<TableAliasName>PartyRollup_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTPartyRollup</TableStoredProcPrefix>")
