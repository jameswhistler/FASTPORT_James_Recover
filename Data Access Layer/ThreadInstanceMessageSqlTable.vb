...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="ThreadInstanceMessageTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class ThreadInstanceMessageSqlTable
		Inherits BaseThreadInstanceMessageSqlTable
