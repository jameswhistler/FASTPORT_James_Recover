...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_SecurityRoleView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_SecurityRoleSqlView
		Inherits BaseV_SecurityRoleSqlView
