...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyExperienceTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyExperienceSqlTable
		Inherits BasePartyExperienceSqlTable
