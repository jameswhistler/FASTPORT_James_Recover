...
''' <see cref="V_PartyUserRolesView">FASTPORT.V_PartyUserRolesView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_PartyUserRolesView"></seealso>

Public Class V_PartyUserRolesDefinition

#Region "Definition (XML) for V_PartyUserRolesDefinition table"
	'Next 169 lines contain Table Definition (XML) for table "V_PartyUserRolesDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_PartyUserRolesView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_PartyUserRoles</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_PartyUserRoles</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_PartyUserRoles_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_PartyUserRoles</TableStoredProcPrefix>")
