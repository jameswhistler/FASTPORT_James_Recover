...
''' <see cref="V_SignAddrView">FASTPORT.V_SignAddrView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_SignAddrView"></seealso>

Public Class V_SignAddrDefinition

#Region "Definition (XML) for V_SignAddrDefinition table"
	'Next 322 lines contain Table Definition (XML) for table "V_SignAddrDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_SignAddrView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_SignAddr</TableName>")
         tbf.Append(  "<Version>5</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_SignAddr</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_SignAddr_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_SignAddr</TableStoredProcPrefix>")
