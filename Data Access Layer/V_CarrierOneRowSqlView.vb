...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_CarrierOneRowView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_CarrierOneRowSqlView
		Inherits BaseV_CarrierOneRowSqlView
