...
''' <summary>
''' Used by the <see cref="V_PartyCarriersView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_PartyCarriersSqlView
	Inherits BaseV_PartyCarriersSqlView
