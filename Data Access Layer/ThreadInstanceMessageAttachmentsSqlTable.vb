...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="ThreadInstanceMessageAttachmentsTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class ThreadInstanceMessageAttachmentsSqlTable
		Inherits BaseThreadInstanceMessageAttachmentsSqlTable
