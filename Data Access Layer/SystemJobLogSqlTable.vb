...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="SystemJobLogTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SystemJobLogSqlTable
		Inherits BaseSystemJobLogSqlTable
