...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="SystemServiceTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class SystemServiceSqlTable
		Inherits BaseSystemServiceSqlTable
