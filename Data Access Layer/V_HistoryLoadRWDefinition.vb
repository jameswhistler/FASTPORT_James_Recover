...
''' <see cref="V_HistoryLoadRWView">FASTPORT.V_HistoryLoadRWView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_HistoryLoadRWView"></seealso>

Public Class V_HistoryLoadRWDefinition

#Region "Definition (XML) for V_HistoryLoadRWDefinition table"
	'Next 1084 lines contain Table Definition (XML) for table "V_HistoryLoadRWDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_HistoryLoadRWView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>StartMonth</columnName>")
         ...
         tbf.Append(      "<columnName>EndMonth</columnName>")
         ...
         tbf.Append(      "<columnName>PositionTypeID</columnName>")
         tbf.Append(      "<columnUIName>Position Type</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>CurrentPastID</columnName>")
         tbf.Append(      "<columnUIName>Current Past</columnUIName>")
         ...
         tbf.Append(      "<columnName>EmployerCitySTZip</columnName>")
         tbf.Append(      "<columnUIName>Employer City ST ZIP</columnUIName>")
         ...
         tbf.Append(      "<columnName>EmployerCountry</columnName>")
         tbf.Append(      "<columnUIName>Employer Country</columnUIName>")
         ...
         tbf.Append(      "<columnName>ReasonForLeaving</columnName>")
         tbf.Append(      "<columnUIName>Reason For Leaving</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>nvarchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>255</columnLengthSet>")
         ...
         tbf.Append(      "<columnName>ShowFirstJob</columnName>")
         tbf.Append(      "<columnUIName>Show First Job</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>50</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_HistoryLoadRW</TableName>")
         tbf.Append(  "<Version>3</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_HistoryLoadRW</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_HistoryLoadRW_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_HistoryLoadRW</TableStoredProcPrefix>")
