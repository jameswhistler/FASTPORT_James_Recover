...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="CheckInActivityTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class CheckInActivitySqlTable
		Inherits BaseCheckInActivitySqlTable
