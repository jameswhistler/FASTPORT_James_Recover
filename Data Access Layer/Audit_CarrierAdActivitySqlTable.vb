...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="Audit_CarrierAdActivityTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class Audit_CarrierAdActivitySqlTable
		Inherits BaseAudit_CarrierAdActivitySqlTable
