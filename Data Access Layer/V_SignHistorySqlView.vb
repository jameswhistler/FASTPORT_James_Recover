...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_SignHistoryView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_SignHistorySqlView
		Inherits BaseV_SignHistorySqlView
