...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_SignEmployerView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_SignEmployerSqlView
		Inherits BaseV_SignEmployerSqlView
