...
''' <see cref="FlowStepTable">FASTPORT.FlowStepTable</see> class
...
#Region "Definition (XML) for FlowStepDefinition table"
	'Next 529 lines contain Table Definition (XML) for table "FlowStepDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="FlowStepTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>FK_FlowStep_FlowCollection</columnFKName>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_FlowStep_FlowOverview</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.FlowOverviewTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>OverviewID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>Overview</columnFKColumnDisplay>")
         tbf.Append(        "<foreignKeyType>Explicit</foreignKeyType>")
         tbf.Append(      "</foreignKey>")
         tbf.Append(      "<applyDFKA>Y</applyDFKA>")
         tbf.Append(      "<applyInitializeInsertingRecord>N</applyInitializeInsertingRecord>")
         ...
         tbf.Append(      "<columnName>StepRank</columnName>")
         tbf.Append(      "<columnUIName>Step Rank</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>FlowStatus</columnName>")
         tbf.Append(      "<columnUIName>Flow Status</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>50</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>ReturnedDocStep</columnName>")
         tbf.Append(      "<columnUIName>Returned Document Step</columnUIName>")
         ...
         tbf.Append(      "<columnName>DisableStep</columnName>")
         tbf.Append(      "<columnUIName>Disable Step</columnUIName>")
         tbf.Append(      "<columnType>Boolean</columnType>")
         tbf.Append(      "<columnDBType>bit</columnDBType>")
         tbf.Append(      "<columnLengthSet></columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>CopyFlowStepID</columnName>")
         tbf.Append(      "<columnUIName>Copy Flow Step</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>FlowStep</TableName>")
         tbf.Append(  "<Version>5</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>FlowStep</TableCodeName>")
         tbf.Append(  "<TableAliasName>FlowStep_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTFlowStep</TableStoredProcPrefix>")
