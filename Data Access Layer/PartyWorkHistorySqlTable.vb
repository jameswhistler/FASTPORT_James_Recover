...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyWorkHistoryTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyWorkHistorySqlTable
		Inherits BasePartyWorkHistorySqlTable
