...
''' <see cref="ThreadInstanceMessageAttachmentsTable">FASTPORT.ThreadInstanceMessageAttachmentsTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="ThreadInstanceMessageAttachmentsTable"></seealso>

Public Class ThreadInstanceMessageAttachmentsDefinition

#Region "Definition (XML) for ThreadInstanceMessageAttachmentsDefinition table"
	'Next 331 lines contain Table Definition (XML) for table "ThreadInstanceMessageAttachmentsDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="ThreadInstanceMessageAttachmentsTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(        "<columnFKName>FK_ThreadInstanceMessageAttachments_ThreadInstanceMessage</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.ThreadInstanceMessageTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>MessageID</columnFKColumn>")
         tbf.Append(        "<columnFKColumnDisplay>MessageSubject</columnFKColumnDisplay>")
         ...
         tbf.Append(      "<columnName>FileName</columnName>")
         tbf.Append(      "<columnUIName>File Name</columnUIName>")
         ...
         tbf.Append(      "<columnName>Attachment</columnName>")
         tbf.Append(      "<columnUIName>Attachment</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>ThreadInstanceMessageAttachments</TableName>")
         tbf.Append(  "<Version>2</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>ThreadInstanceMessageAttachments</TableCodeName>")
         tbf.Append(  "<TableAliasName>ThreadInstanceMessageAttachments_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTThreadInstanceMessageAttachments</TableStoredProcPrefix>")
