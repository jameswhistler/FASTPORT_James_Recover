...
''' <see cref="PartyRoleTable">FASTPORT.PartyRoleTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="PartyRoleTable"></seealso>

Public Class PartyRoleDefinition

#Region "Definition (XML) for PartyRoleDefinition table"
	'Next 348 lines contain Table Definition (XML) for table "PartyRoleDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="PartyRoleTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnUIName>Party Role</columnUIName>")
         ...
         tbf.Append(        "<columnFKName>FK_PartyRole_PartyRollup</columnFKName>")
         tbf.Append(        "<columnFKTable>FASTPORT.Business.PartyRollupTable, FASTPORT.Business</columnFKTable>")
         tbf.Append(        "<columnFKOwner>dbo</columnFKOwner>")
         tbf.Append(        "<columnFKColumn>RollupID</columnFKColumn>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_RoleParty_Party</columnFKName>")
         ...
         tbf.Append(      "<applyLabelText>Y</applyLabelText>")
         tbf.Append(      "<foreignKey>")
         tbf.Append(        "<columnFKName>FK_RoleParty_Role</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>PartyRole</TableName>")
         tbf.Append(  "<Version>4</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>PartyRole</TableCodeName>")
         tbf.Append(  "<TableAliasName>PartyRole_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTPartyRole</TableStoredProcPrefix>")
