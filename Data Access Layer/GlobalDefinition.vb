...
''' <see cref="GlobalTable">FASTPORT.GlobalTable</see> class
...
#Region "Definition (XML) for GlobalDefinition table"
	'Next 207 lines contain Table Definition (XML) for table "GlobalDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="GlobalTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>GlobalID</columnName>")
         tbf.Append(      "<columnUIName>Global</columnUIName>")
         ...
         tbf.Append(      "<columnName>GlobalName</columnName>")
         tbf.Append(      "<columnUIName>Global Name</columnUIName>")
         ...
         tbf.Append(      "<columnName>GlobalDescription</columnName>")
         tbf.Append(      "<columnUIName>Global Description</columnUIName>")
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         ...
         tbf.Append(      "<columnName>GlobalFile</columnName>")
         tbf.Append(      "<columnUIName>Global File</columnUIName>")
         ...
         tbf.Append(      "<columnName>GlobalValue</columnName>")
         tbf.Append(      "<columnUIName>Global Value</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Global</TableName>")
         tbf.Append(  "<Version>3</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>Global</TableCodeName>")
         tbf.Append(  "<TableAliasName>Global_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTGlobal</TableStoredProcPrefix>")
