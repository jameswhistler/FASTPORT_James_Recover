...
''' <see cref="V_RolesGeneralView">FASTPORT.V_RolesGeneralView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_RolesGeneralView"></seealso>

Public Class V_RolesGeneralDefinition

#Region "Definition (XML) for V_RolesGeneralDefinition table"
	'Next 248 lines contain Table Definition (XML) for table "V_RolesGeneralDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_RolesGeneralView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_RolesGeneral</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_RolesGeneral</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_RolesGeneral_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_RolesGeneral</TableStoredProcPrefix>")
