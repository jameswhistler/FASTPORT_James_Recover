...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_PersonWithPicView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_PersonWithPicSqlView
		Inherits BaseV_PersonWithPicSqlView
