...
''' <see cref="V_SignDocs_OneRowView">FASTPORT.V_SignDocs_OneRowView</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="V_SignDocs_OneRowView"></seealso>

Public Class V_SignDocs_OneRowDefinition

#Region "Definition (XML) for V_SignDocs_OneRowDefinition table"
	'Next 626 lines contain Table Definition (XML) for table "V_SignDocs_OneRowDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="V_SignDocs_OneRowView"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnType>String</columnType>")
         tbf.Append(      "<columnDBType>varchar</columnDBType>")
         tbf.Append(      "<columnLengthSet>3050</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         tbf.Append(      "<columnDBDefault></columnDBDefault>")
         tbf.Append(      "<columnIndex>N</columnIndex>")
         tbf.Append(      "<columnUnique>N</columnUnique>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>v_SignDocs_OneRow</TableName>")
         tbf.Append(  "<Version>1</Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>V_SignDocs_OneRow</TableCodeName>")
         tbf.Append(  "<TableAliasName>V_SignDocs_OneRow_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTV_SignDocs_OneRow</TableStoredProcPrefix>")
