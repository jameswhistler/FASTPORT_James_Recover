...
''' <see cref="PaymentMethodPartyTable">FASTPORT.PaymentMethodPartyTable</see> class
''' to initialize the class's TableDefinition.
''' </summary>
''' <seealso cref="PaymentMethodPartyTable"></seealso>

Public Class PaymentMethodPartyDefinition

#Region "Definition (XML) for PaymentMethodPartyDefinition table"
	'Next 302 lines contain Table Definition (XML) for table "PaymentMethodPartyDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="PaymentMethodPartyTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>PaymentMethodPartyID</columnName>")
         tbf.Append(      "<columnUIName>Payment Method Party</columnUIName>")
         ...
         tbf.Append(        "<columnFKName>FK_PaymentMethodParty_PaymentMethod</columnFKName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>PaymentMethodParty</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>PaymentMethodParty</TableCodeName>")
         tbf.Append(  "<TableAliasName>PaymentMethodParty_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTPaymentMethodParty</TableStoredProcPrefix>")
