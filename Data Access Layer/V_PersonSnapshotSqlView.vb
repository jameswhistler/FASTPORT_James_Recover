...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="V_PersonSnapshotView"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class V_PersonSnapshotSqlView
		Inherits BaseV_PersonSnapshotSqlView
