...
''' <see cref="RefTable">FASTPORT.RefTable</see> class
...
#Region "Definition (XML) for RefDefinition table"
	'Next 523 lines contain Table Definition (XML) for table "RefDefinition"
	Private Shared _DefinitionString As String = ""
#End Region
	
	''' <summary>
	''' Gets the embedded schema and configuration data for the  
	''' <see cref="RefTable"></see>
	...
	Public Shared Function GetXMLString() As String
		If _DefinitionString = "" Then
         ...
         tbf.Append(      "<columnName>RefID</columnName>")
         tbf.Append(      "<columnUIName>Reference</columnUIName>")
         ...
         tbf.Append(      "<columnName>RefTypeID</columnName>")
         tbf.Append(      "<columnUIName>Reference Type</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>OrdID</columnName>")
         ...
         tbf.Append(        "<columnFKName>FK_Ref_Party</columnFKName>")
         ...
         tbf.Append(      "<columnName>PartyUserID</columnName>")
         tbf.Append(      "<columnUIName>Party User</columnUIName>")
         tbf.Append(      "<columnType>Number</columnType>")
         tbf.Append(      "<columnDBType>int</columnDBType>")
         tbf.Append(      "<columnLengthSet>10.0</columnLengthSet>")
         tbf.Append(      "<columnDefault></columnDefault>")
         ...
         tbf.Append(      "<columnName>IssuedAt</columnName>")
         tbf.Append(      "<columnUIName>Issued At</columnUIName>")
         ...
         tbf.Append(    "</Column>")
         tbf.Append(  "</ColumnDefinition>")
         tbf.Append(  "<TableName>Ref</TableName>")
         tbf.Append(  "<Version></Version>")
         tbf.Append(  "<Owner>dbo</Owner>")
         tbf.Append(  "<TableCodeName>Ref</TableCodeName>")
         tbf.Append(  "<TableAliasName>Ref_</TableAliasName>")
         ...
         tbf.Append(  "<TableStoredProcPrefix>pFASTPORTRef</TableStoredProcPrefix>")
