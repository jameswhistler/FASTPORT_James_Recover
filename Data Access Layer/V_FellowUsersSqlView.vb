...
''' <summary>
''' Used by the <see cref="V_FellowUsersView"></see> class to access and/or modify the database.
''' </summary>
''' <remarks>
...
Public Class V_FellowUsersSqlView
	Inherits BaseV_FellowUsersSqlView
