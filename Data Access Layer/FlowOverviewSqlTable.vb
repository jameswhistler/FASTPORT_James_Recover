...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="FlowOverviewTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class FlowOverviewSqlTable
		Inherits BaseFlowOverviewSqlTable
