...
Namespace FASTPORT.Data
	...
	''' <summary>
	''' Used by the <see cref="PartyIncidentTable"></see> class to access and/or modify the database.
	''' </summary>
	''' <remarks>
	...
	Public Class PartyIncidentSqlTable
		Inherits BasePartyIncidentSqlTable
