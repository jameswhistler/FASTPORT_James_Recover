...
' This file implements the code-behind class for AddRole.aspx.
' AddRole.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the AddRole page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents AgreementAddButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents AgreementButtonsButton As ThemeButtonWithArrow
        Public WithEvents AgreementDeleteButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents AgreementTableControl As FASTPORT.UI.Controls.AddRole.AgreementTableControl
        Public WithEvents AgreementToggleAll As System.Web.UI.WebControls.CheckBox
        ...
        Public WithEvents CarrierAdContactsAddButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents CarrierAdContactsButtonsButton As ThemeButtonWithArrow
        Public WithEvents CarrierAdContactsDeleteButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents CarrierAdContactsTableControl As FASTPORT.UI.Controls.AddRole.CarrierAdContactsTableControl
        Public WithEvents CarrierAdContactsToggleAll As System.Web.UI.WebControls.CheckBox
        ...
        Public WithEvents CreatedByIDSortLabel1 As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents DocTreeAddButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents DocTreeButtonsButton As ThemeButtonWithArrow
        Public WithEvents DocTreeDeleteButton As System.Web.UI.WebControls.ImageButton
        ...
        Public WithEvents DocTreeTableControl As FASTPORT.UI.Controls.AddRole.DocTreeTableControl
        Public WithEvents DocTreeToggleAll As System.Web.UI.WebControls.CheckBox
        ...
        Public WithEvents GeneralRoleID As System.Web.UI.WebControls.DropDownList
        Public WithEvents GeneralRoleIDAddRecordLink As System.Web.UI.WebControls.ImageButton
        Public WithEvents GeneralRoleIDLabel As System.Web.UI.WebControls.Literal
        Public WithEvents ItemRankSortLabel As System.Web.UI.WebControls.LinkButton
        ...
        Public WithEvents RoleRecordControl As FASTPORT.UI.Controls.AddRole.RoleRecordControl
        Public WithEvents RoleTitle As System.Web.UI.WebControls.Literal
        Public WithEvents RoleTypeID As System.Web.UI.WebControls.DropDownList
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            Me.SaveAndNewButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, """ & Me.GetResourceValue("Txt:SaveRecord", "FASTPORT") & """);")
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      id = Me.RoleRecordControl.DataSource.RoleID.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          ...
                          variables.Add(Me.RoleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.RoleRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.RoleRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.RoleRecordControl.DataSource.GetValue(Me.RoleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
