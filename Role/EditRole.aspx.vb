...
' This file implements the code-behind class for EditRole.aspx.
' EditRole.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the EditRole page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents AgreementTableControl As FASTPORT.UI.Controls.EditRole.AgreementTableControl
        ...
        Public WithEvents CarrierAdContactsTableControl As FASTPORT.UI.Controls.EditRole.CarrierAdContactsTableControl
        ...
        Public WithEvents DocTreeTableControl As FASTPORT.UI.Controls.EditRole.DocTreeTableControl
        ...
        Public WithEvents RoleRecordControl As FASTPORT.UI.Controls.EditRole.RoleRecordControl
