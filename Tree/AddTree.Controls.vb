...
' AddTree.aspx page.  The Row or RecordControl classes are the 
...
Namespace FASTPORT.UI.Controls.AddTree
...
' Base class for the TreeRecordControl control on the AddTree page.
...
Public Class BaseTreeRecordControl
        ...
        Public Overridable Sub LoadData()        
            ...
            Me.DataSource = CType(TreeRecord.Copy(recList(0), False), TreeRecord)
        ...
        Public Overridable Sub SetTreeParentID()
            ...
            Else 
                ...
                Me.TreeParentID.Text = EvaluateFormula("URL(""TreeParent"")", Me.DataSource)		
                End If
        ...
        Public Overridable Function CreateWhereClause() As WhereClause
            ...
            Dim recId As String = Me.Page.Request.QueryString.Item("Tree")
            ...
            HttpContext.Current.Session("QueryString in AddTree") = recId
