...
' This file implements the code-behind class for AddTree.aspx.
' AddTree.Controls.vb contains the Table, Row and Record control classes
...
Namespace FASTPORT.UI
    ...
    Partial Public Class AddTree
        Inherits BaseApplicationPage
        ' Code-behind class for the AddTree page.
...
#End Region
        ...
        Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            ' Customize by adding code before the call or replace the call to the Base function with your own code.
            SaveButton_Click_Base_Cust(sender, args)
            ' NOTE: If the Base function redirects to another page, any code here will not be executed.
        ...
        Public Sub SaveButton_Click_Base_Cust(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Try
                ...
                Dim myCurrentNode As String = Me.TreeRecordControl.DataSource.TreeID.ToString
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents TreeRecordControl As FASTPORT.UI.Controls.AddTree.TreeRecordControl
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Tree"
        End Sub
