...
' This file implements the code-behind class for EditTree.aspx.
' EditTree.Controls.vb contains the Table, Row and Record control classes
...
Namespace FASTPORT.UI
    ...
    Partial Public Class EditTree
        Inherits BaseApplicationPage
        ' Code-behind class for the EditTree page.
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents AdminOnly As System.Web.UI.WebControls.CheckBox
        Public WithEvents AdminOnlyLabel As System.Web.UI.WebControls.Literal
        Public WithEvents CancelButton As ThemeButton
        Public WithEvents DescriptionLabel As System.Web.UI.WebControls.Literal
        Public WithEvents FolderOnly As System.Web.UI.WebControls.CheckBox
        Public WithEvents FolderOnlyLabel As System.Web.UI.WebControls.Literal
        Public WithEvents Hide As System.Web.UI.WebControls.CheckBox
        Public WithEvents ItemNameLabel As System.Web.UI.WebControls.Literal
        Public WithEvents ItemRankLabel As System.Web.UI.WebControls.Literal
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents SaveButton As ThemeButton
        Public WithEvents TreeID As System.Web.UI.WebControls.Literal
        Public WithEvents TreeRecordControl As FASTPORT.UI.Controls.EditTree.TreeRecordControl
    ...
    ' Enclose all database retrieval/update code within a Transaction boundary
            ...
            If Not TargetKey Is Nothing Then
                      ...
                      If Not Me.TreeRecordControl Is Nothing AndAlso Not Me.TreeRecordControl.DataSource Is Nothing Then
                      
                      id = Me.TreeRecordControl.DataSource.TreeID.ToString
                      If not String.IsNullOrEmpty(DFKA) then
                          If DFKA.Trim().StartsWith("=") then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TreeRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TreeRecordControl.DataSource)
                              value = EvaluateFormula(DFKA, Me.TreeRecordControl.DataSource, Nothing,variables)
                          Else
                              value = Me.TreeRecordControl.DataSource.GetValue(Me.TreeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString
                          End If
                       End If
                      ...
                      If Not Formula Is Nothing Then
                          Dim variables as System.Collections.Generic.IDictionary(Of String, Object) = new System.Collections.Generic.Dictionary(Of String, Object)()
                          variables.Add(Me.TreeRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, Me.TreeRecordControl.DataSource)
                          value = EvaluateFormula(formula, Me.TreeRecordControl.DataSource, Nothing,variables)
                      End If
