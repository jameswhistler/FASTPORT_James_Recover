...
' This file implements the code-behind class for EditTreeImage.aspx.
' EditTreeImage.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class EditTreeImage
        Inherits BaseApplicationPage
' Code-behind class for the EditTreeImage page.
...
#Region "Section 1: Place your customizations here."
      ...
      End Sub
        ...
        Public Sub s_LoadImage()

            Dim myItemRadBinaryImage As RadBinaryImage = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "ItemRadBinaryImage"), RadBinaryImage)

            Dim myWhere As String = TreeTable.TreeID.UniqueName & " = " & Me.TreeRecordControl.TreeID.Text
            Dim myRec As TreeRecord = TreeTable.GetRecord(myWhere)

            If myRec.ItemImage IsNot Nothing Then
                Dim buffer() As Byte = CType(myRec.ItemImage, Byte())
            ...
            myItemRadBinaryImage = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "ItemGlowRadBinaryImage"), RadBinaryImage)

            If myRec.ItemImageGlow IsNot Nothing Then
                Dim buffer() As Byte = CType(myRec.ItemImageGlow, Byte())
                Dim newStream As New System.IO.MemoryStream(buffer)
                Dim myFileAsArray As Byte() = New Byte(CInt(newStream.Length) - 1) {}
                newStream.Read(myFileAsArray, 0, myFileAsArray.Length)
            ...
            myItemRadBinaryImage = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "ItemGrayRadBinaryImage"), RadBinaryImage)

            If myRec.ItemImageGray IsNot Nothing Then
                Dim buffer() As Byte = CType(myRec.ItemImageGray, Byte())
                Dim newStream As New System.IO.MemoryStream(buffer)
                Dim myFileAsArray As Byte() = New Byte(CInt(newStream.Length) - 1) {}
                newStream.Read(myFileAsArray, 0, myFileAsArray.Length)
            ...
            myItemRadBinaryImage = DirectCast(MiscUtils.FindControlRecursively(Me.Page, "ItemLowResRadBinaryImage"), RadBinaryImage)

            If myRec.ItemImageLowRes IsNot Nothing Then
                Dim buffer() As Byte = CType(myRec.ItemImageLowRes, Byte())
                Dim newStream As New System.IO.MemoryStream(buffer)
                Dim myFileAsArray As Byte() = New Byte(CInt(newStream.Length) - 1) {}
                newStream.Read(myFileAsArray, 0, myFileAsArray.Length)
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents DeleteGlowButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents DeleteGrayButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents DeleteImageButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents DeleteLowResButton As System.Web.UI.WebControls.ImageButton
        Public WithEvents GlowLabel As System.Web.UI.WebControls.Literal
        Public WithEvents GrayLabel As System.Web.UI.WebControls.Literal
        Public WithEvents Hide As System.Web.UI.WebControls.CheckBox
        Public WithEvents ImageLabel As System.Web.UI.WebControls.Literal
        Public WithEvents ItemImageLabel As System.Web.UI.WebControls.Literal
        Public WithEvents LowResLabel As System.Web.UI.WebControls.Literal
        Public WithEvents PageTitle As System.Web.UI.WebControls.Literal
        Public WithEvents TreeID As System.Web.UI.WebControls.Literal
        Public WithEvents TreeRecordControl As FASTPORT.UI.Controls.EditTreeImage.TreeRecordControl
        Public WithEvents UploadButton As ThemeButton
        Public WithEvents UploadGlowButton As ThemeButton
        Public WithEvents UploadGrayButton As ThemeButton
        Public WithEvents UploadLowResButton As ThemeButton
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Edit") + " Tree"
        End Sub
    ...
    End Function
      ...
      End Sub  
        ...
        Me.TreeRecordControl.LoadData()
        Me.TreeRecordControl.DataBind()
                ...
                If Not pageMaster is Nothing Then
                    ...
                    If Not menuComponent is Nothing Then
                        menuComponent.HiliteSettings = "TreeMenuItem"
                    End If
                End If
