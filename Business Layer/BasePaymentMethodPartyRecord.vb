...
''' <summary>
''' The generated superclass for the <see cref="PaymentMethodPartyRecord"></see> class.
''' </summary>
''' <remarks>
...
<Serializable()> Public Class BasePaymentMethodPartyRecord
	Inherits PrimaryKeyRecord
	

	Public Shared Shadows ReadOnly TableUtils As PaymentMethodPartyTable = PaymentMethodPartyTable.Instance
    ...
    Public Overridable Sub PaymentMethodPartyRecord_InsertingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.InsertingRecord
        'Apply Initialize->Inserting record formula only if validation is successful.
        	        Dim PaymentMethodPartyRec As PaymentMethodPartyRecord = CType(sender,PaymentMethodPartyRecord)
        Validate_Inserting()
        If Not PaymentMethodPartyRec Is Nothing AndAlso Not PaymentMethodPartyRec.IsReadOnly Then
                End If
    End Sub

	'Evaluates Initialize when->Updating record formulas specified at the data access layer
    Public Overridable Sub PaymentMethodPartyRecord_UpdatingRecord(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.UpdatingRecord
    ...
    Public Overridable Sub PaymentMethodPartyRecord_ReadRecord(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReadRecord
...
#Region "Convenience methods to get/set values of fields"
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.PaymentMethodPartyID field.
	''' </summary>
	Public Function GetPaymentMethodPartyIDValue() As ColumnValue
		Return Me.GetValue(TableUtils.PaymentMethodPartyIDColumn)
	End Function

	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.PaymentMethodPartyID field.
	''' </summary>
	Public Function GetPaymentMethodPartyIDFieldValue() As Int32
		Return CType(Me.GetValue(TableUtils.PaymentMethodPartyIDColumn).ToInt32(), Int32)
	End Function

	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.PaymentMethodID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's PaymentMethodParty_.PaymentMethodID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.PartyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's PaymentMethodParty_.PartyID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.CreatedByID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's PaymentMethodParty_.CreatedByID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.CreatedAt field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's PaymentMethodParty_.CreatedAt field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.UpdatedByID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's PaymentMethodParty_.UpdatedByID field.
	''' </summary>
	...
	End Sub
	''' <summary>
	''' This is a convenience method that provides direct access to the value of the record's PaymentMethodParty_.UpdatedAt field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience method that allows direct modification of the value of the record's PaymentMethodParty_.UpdatedAt field.
	''' </summary>
...
#Region "Convenience methods to get field names"
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.PaymentMethodPartyID field.
	''' </summary>
	Public Property PaymentMethodPartyID() As Int32
		Get 
			Return CType(Me.GetValue(TableUtils.PaymentMethodPartyIDColumn).ToInt32(), Int32)
		End Get
		Set (ByVal val As Int32) 
			Dim colValue As ColumnValue = New ColumnValue(val)
			Me.SetValue(colValue, TableUtils.PaymentMethodPartyIDColumn)
		End Set
	End Property
	...
	''' </summary>
	Public ReadOnly Property PaymentMethodPartyIDSpecified() As Boolean
        Get
            Dim val As ColumnValue = Me.GetValue(TableUtils.PaymentMethodPartyIDColumn)
	...
	''' </summary>
    Public ReadOnly Property PaymentMethodPartyIDDefault() As String
        Get
            Return TableUtils.PaymentMethodPartyIDColumn.DefaultValue
        End Get
    End Property

	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.PaymentMethodID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.PartyID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.CreatedByID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.CreatedAt field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.UpdatedByID field.
	''' </summary>
	...
	''' <summary>
	''' This is a convenience property that provides direct access to the value of the record's PaymentMethodParty_.UpdatedAt field.
	''' </summary>
