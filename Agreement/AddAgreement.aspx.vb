...
' This file implements the code-behind class for AddAgreement.aspx.
' AddAgreement.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddAgreement
        Inherits BaseApplicationPage
' Code-behind class for the AddAgreement page.
...
'        End Sub
        ...
        Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Dim myAgreementID As String = s_Save()
            myAgreementID = CustGenClass.f_Encrypt(myAgreementID)
            Dim myURL As String = "../Agreement/EditAgreement.aspx?Agreement=" & myAgreementID & "&Close=Yes"
            Me.Page.Response.Redirect(myURL)
            

        End Sub
            
        Public Function s_Save() As String

            Dim myAgreement As String = Me.AgreementRecordControl.Agreement.Text
            Dim myDescription As String = Me.AgreementRecordControl.Description.Text
            Dim myParent As String = Me.AgreementRecordControl.DocTreeParentID.Text
            Dim myCIX As String = CType(Me.Page, BaseApplicationPage).Decrypt(Me.Page.Request.QueryString("CIX"))
            Dim myRoleID As String = Me.RoleID.SelectedValue

            If String.IsNullOrEmpty(myRoleID) Then
                myRoleID = "0"
            End If

            If String.IsNullOrEmpty(myParent) Then
                myParent = "0"
            End If

            If String.IsNullOrEmpty(myCIX) Then
                myCIX = CType(HttpContext.Current.Session("PartyParent"), String)
            End If

            Dim mySproc As String = CustGenClass.f_Sproc("usp_AgreementAdd", myAgreement, myDescription, myParent, myCIX, myRoleID)

            If mySproc = "0" Then
                Dim myMessage As String = "WARNING:  The system failed to add your folder or document.  If the problem continues, please contact support."
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents AgreementRecordControl As FASTPORT.UI.Controls.AddAgreement.AgreementRecordControl
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           Me.SetPageFocus()
            ...
            Page.Title = GetResourceValue("Title:Add") + " Agreement"
        End Sub
