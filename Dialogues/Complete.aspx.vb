...
' This file implements the code-behind class for Complete.aspx.
' Complete.Controls.vb contains the Table, Row and Record control classes
...
' Code-behind class for the Complete page.
...
#Region "Section 1: Place your customizations here."
        ...
        Public Sub DashboardButton_Click(ByVal sender As Object, ByVal args As ImageClickEventArgs)
            ...
            'JAR
            Dim myURL As String = "/Dashboards/Dashboard.aspx"
        ...
        Public Overrides Sub s_ShowButtons()
            ...
            Dim myButtonID As String = CustGenClass.f_Decrypt(Me.Page.Request.QueryString("Button"))
            ...
            If Not String.IsNullOrEmpty(myRec.CompletionMessage) Then

                Dim myCompletionMessage As String = myRec.CompletionMessage
                myCompletionMessage = f_URL_ReplaceCommon(myCompletionMessage)
                myInstructionsLiteral.Text = myCompletionMessage

            End If


            Me.DashboardButton.ToolTip = "Click to jump to your Dashboard without changing this workflow"
            Me.DashboardButton.Attributes.Add("CloseYesNo", "False")

            Dim myImageURL As String = BaseApplicationPage.f_ImagePath("2335")
            Me.DashboardButton.Attributes.Add("src", myImageURL)
            Me.DashboardButton.Attributes.Add("Width", "32px")
            Me.DashboardButton.Attributes.Add("Height", "25px")
...
#End Region
    ...
    ' Page Event Handlers - buttons, sort, links
        ...
        Public Sub CloseButton_Click(ByVal sender As Object, ByVal args As EventArgs)
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents CloseButton As ThemeButton
        ...
        Protected Sub Page_InitializeEventHandlers_Base(ByVal sender As Object, ByVal e As System.EventArgs)            		
          ...
          ' Setup the pagination events.
            ...
            AddHandler Me.CloseButton.Button.Click, AddressOf CloseButton_Click
    ...
    Try
        ...
        Public Sub CloseButton_Click_Base(ByVal sender As Object, ByVal args As EventArgs)
