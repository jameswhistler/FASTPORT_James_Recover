if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_FellowUsersGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_FellowUsersGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_FellowUsers]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_FellowUsersGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH V_FellowUsers_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM V_FellowUsers_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            N'V_FellowUsers_.[PartyID],
            V_FellowUsers_.[Name],
            V_FellowUsers_.[UserID],
            V_FellowUsers_.[OtherUserID],
            V_FellowUsers_.[OtherUserName]'
        SET @l_query_from = 
