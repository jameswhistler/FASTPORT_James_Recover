if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_AddrGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_AddrGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_Addr]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_AddrGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            V_Addr_.[Dates],
            V_Addr_.[EditButton],
            V_Addr_.[DeleteButton],
            V_Addr_.[EditImage],
            V_Addr_.[MovedIn],
            V_Addr_.[MovedOut],
            V_Addr_.[MovedOutOn],
            V_Addr_.[Headquarters],
            V_Addr_.[AddrName],
            V_Addr_.[CitySTZip],
            V_Addr_.[CityST] '
        SET @l_query_from = 
        ...
        SET @l_query_where = 
            N'ON V_Addr_.[AddrID] = IS_ALIAS.[AddrID] ' 
