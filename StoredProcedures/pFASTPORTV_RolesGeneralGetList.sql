if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_RolesGeneralGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_RolesGeneralGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_RolesGeneral]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_RolesGeneralGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY V_RolesGeneral_.[RoleID] asc '
        ...
        SET @l_query_cols = 
            N'V_RolesGeneral_.[RoleID],
            V_RolesGeneral_.[GeneralRoleID],
            V_RolesGeneral_.[RoleTypeID],
            V_RolesGeneral_.[Role],
            V_RolesGeneral_.[RoleDescription],
            V_RolesGeneral_.[RoleRank] '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON V_RolesGeneral_.[RoleID] = IS_ALIAS.[RoleID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            V_RolesGeneral_.[RoleRank]'
        SET @l_query_from = 
            ' FROM [dbo].[v_RolesGeneral] V_RolesGeneral_ ' + 
            'WHERE 1=2;'
