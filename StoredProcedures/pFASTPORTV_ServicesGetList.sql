if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_ServicesGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_ServicesGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_Services]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_ServicesGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY V_Services_.[ServiceID] asc '
        ...
        SET @l_query_cols = 
            N'V_Services_.[ServiceID],
            V_Services_.[ServiceContextID],
            V_Services_.[ServiceTypeID],
            V_Services_.[ServiceType],
            V_Services_.[ServiceImage],
            V_Services_.[FastportService],
            V_Services_.[ServiceRequired],
            V_Services_.[Cost],
            V_Services_.[ServiceName],
            V_Services_.[ServiceDescription],
            V_Services_.[Fee],
            V_Services_.[Units],
            V_Services_.[DurationID],
            V_Services_.[Duration],
            V_Services_.[ServiceRank],
            V_Services_.[SubscriptionYesNo] '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON V_Services_.[ServiceID] = IS_ALIAS.[ServiceID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            V_Services_.[SubscriptionYesNo]'
        SET @l_query_from = 
            ' FROM [dbo].[v_Services] V_Services_ ' + 
            'WHERE 1=2;'
