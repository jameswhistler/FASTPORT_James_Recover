if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_PersonWithPicGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_PersonWithPicGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_PersonWithPic]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_PersonWithPicGetList
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
            SET @l_sort_str = N'ORDER BY V_PersonWithPic_.[PartyID] asc '
        ...
        SET @l_query_cols = 
            N'V_PersonWithPic_.[PartyID],
            V_PersonWithPic_.[Name],
            V_PersonWithPic_.[Email],
            V_PersonWithPic_.[FromPic],
            V_PersonWithPic_.[NameHTML],
            V_PersonWithPic_.[MoreHTML],
            V_PersonWithPic_.[Details],
            V_PersonWithPic_.[ProfileSnippet],
            V_PersonWithPic_.[FullProfile],
            V_PersonWithPic_.[BuddyCount],
            V_PersonWithPic_.[RegisteredUserSince] '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON V_PersonWithPic_.[PartyID] = IS_ALIAS.[PartyID] ' 
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            ...
            V_PersonWithPic_.[RegisteredUserSince]'
        SET @l_query_from = 
            ' FROM [dbo].[v_PersonWithPic] V_PersonWithPic_ ' + 
            'WHERE 1=2;'
