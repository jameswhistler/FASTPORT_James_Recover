if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_SecurityUserGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_SecurityUserGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_SecurityUser]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_SecurityUserGetList
...
BEGIN
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            N'V_SecurityUser_.[PartyID],
            V_SecurityUser_.[Name],
            V_SecurityUser_.[Email],
            V_SecurityUser_.[Password],
            V_SecurityUser_.[RegisteredUserSince] '
        SET @l_query_from = 
            'FROM ( ' +
        ...
        SET @l_query_where = 
            N'ON V_SecurityUser_.[PartyID] = IS_ALIAS.[PartyID] ' 
