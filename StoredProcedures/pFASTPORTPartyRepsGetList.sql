if exists (select * from sysobjects where id = object_id(N'pFASTPORTPartyRepsGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTPartyRepsGetList 
GO
...
-- Returns a query resultset from table [dbo].[PartyReps]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTPartyRepsGetList
