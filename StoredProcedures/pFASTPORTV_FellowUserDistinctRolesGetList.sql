if exists (select * from sysobjects where id = object_id(N'pFASTPORTV_FellowUserDistinctRolesGetList') and sysstat & 0xf = 4) drop procedure pFASTPORTV_FellowUserDistinctRolesGetList 
GO
...
-- Returns a query resultset from table [dbo].[v_FellowUserDistinctRoles]
...
--    1) count is 0 ;
--    2) empty resultset.
CREATE PROCEDURE pFASTPORTV_FellowUserDistinctRolesGetList
...
BEGIN
    ...
    SET @l_from_str = '[dbo].[v_FellowUserDistinctRoles] V_FellowUserDistinctRoles_'
    ...
    BEGIN
        ...
        SET @l_query_select = 'WITH V_FellowUserDistinctRoles_ AS ( SELECT  '
        ...
        SET @l_query_select2 = 'SELECT * FROM V_FellowUserDistinctRoles_ '
    ...
    BEGIN
        ...
        SET @l_query_cols = 
            N'V_FellowUserDistinctRoles_.[ParentPartyID],
            V_FellowUserDistinctRoles_.[Name],
            V_FellowUserDistinctRoles_.[RoleID],
            V_FellowUserDistinctRoles_.[Role],
            V_FellowUserDistinctRoles_.[PartyID]'
        SET @l_query_from = 
            ' FROM [dbo].[v_FellowUserDistinctRoles] V_FellowUserDistinctRoles_ ' + 
            'WHERE 1=2;'
