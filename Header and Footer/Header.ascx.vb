    ...
    End Function
      ...
      Select Case (DirectCast(Me.Page, BaseApplicationPage).CurrentSecurity.GetUserStatus())
            Case Nothing, ""
                      ...
                      Me.SignIn.Text = GetResourceValue("Txt:SignIn", "FASTPORT")
                      Me.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "FASTPORT")
                    
      Case Else
          
                Me.SignIn.Text = GetResourceValue("Txt:SignOut", "FASTPORT")
                Me.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "FASTPORT")
