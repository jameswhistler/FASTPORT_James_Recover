...
#Region "Section 2: Do not modify this section."
       ...
       Protected Overridable Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
           ...
           If ( Me.IsPostBack ) Then
                      ...
                      If ( Not IsNothing(ddlPageSize) AndAlso Not IsNothing(textPageSize) ) Then
                                 textPageSize.Text = ddlPageSize.Text
                      End If
    ...
    End Function
      ...
      End Sub  
        ...
        NotifyParentProperty(True), _
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
        Public ReadOnly Property _PageSizeSelector() As System.Web.UI.WebControls.DropDownList Implements IPaginationModern._PageSizeSelector
            Get
