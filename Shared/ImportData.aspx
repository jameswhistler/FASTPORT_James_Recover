...
<%@ Page Language="VB" EnableEventValidation="false" AutoEventWireup="false" Codebehind="ImportData.aspx.vb" Inherits="FASTPORT.UI.ImportData" %>
				...
				<table class="importWizarddv" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="importWizarddBody" style="width:100%; height:100%">			
							...
							<table>
								<tr>
									<td><FASTPORT:ThemeButton runat="server" id="PreviousButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Previous&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Previous&quot;, &quot;FASTPORT&quot;) %>">
		</FASTPORT:ThemeButton></td>
									<td><FASTPORT:ThemeButton runat="server" id="ImportButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Import&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Import&quot;, &quot;FASTPORT&quot;) %>">
		</FASTPORT:ThemeButton></td>
								</tr>
							</table>
						</td>
