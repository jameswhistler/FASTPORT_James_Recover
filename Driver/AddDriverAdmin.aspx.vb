...
' This file implements the code-behind class for AddDriverAdmin.aspx.
' AddDriverAdmin.Controls.vb contains the Table, Row and Record control classes
...
Partial Public Class AddDriverAdmin
        Inherits BaseApplicationPage
' Code-behind class for the AddDriverAdmin page.
' Place your customizations in Section 1. Do not modify Section 2.
        
#Region "Section 1: Place your customizations here."

        Protected WithEvents EmailRTB As RadTextBox
        Protected WithEvents PasswordRTB As RadTextBox
        Protected WithEvents NameRTB As RadTextBox
        Protected WithEvents HandleRTB As RadTextBox
        Protected WithEvents DirectDialRadTB As RadMaskedTextBox
        Protected WithEvents MobileRadTB As RadMaskedTextBox
        Protected WithEvents OtherRadTB As RadMaskedTextBox
        Protected WithEvents FaxRadTB As RadMaskedTextBox

        Protected WithEvents CarrierRCB As RadComboBox
        Protected WithEvents JobRCB As RadComboBox

        Dim objRandom As New System.Random(CType(System.DateTime.Now.Ticks Mod System.Int32.MaxValue, Integer))
        Public Function f_GetRandomNumber(Optional ByVal Low As Integer = 100, Optional ByVal High As Integer = 100000) As Integer
        ...
        Public Sub CarrierRCB_Click() Handles CarrierRCB.SelectedIndexChanged
        ...
        Public Sub SaveButton_Click(ByVal sender As Object, ByVal args As EventArgs)
            ...
            Try
                ...
                Dim myRec As New PartyRecord

                myRec.PartyTypeID = 7
                myRec.Email = EmailRTB.Text

                Dim myPassword As String = PasswordRTB.Text
                If String.IsNullOrEmpty(myPassword) Then
                    myPassword = "Temp-" & CStr(f_GetRandomNumber())
                End If

                myRec.Password = PasswordRTB.Text
                myRec.Name = NameRTB.Text
                myRec.Handle = HandleRTB.Text
                ...
                System.Web.HttpContext.Current.Session("AddDriverAdminID") = myRec.PartyID
            ...
            Finally
                ...
                Dim myPartyID As String = CType(HttpContext.Current.Session("AddDriverAdminID"), String)
                s_AddFKs(myPartyID)
                s_Job(myPartyID)
            ...
            Me.CloseWindow(True)
            ClientScript.RegisterStartupScript(Page.GetType(), "mykey", "ChildCloseAndRedirect('RefreshGrid');", True)

        End Sub


        Public Sub s_AddFKs(ByVal myPartyID As String)

            Dim myUserID As String = CType(Me.Page, BaseApplicationPage).SystemUtils.GetUserID()
            Dim mySproc As String = CustGenClass.f_Sproc("usp_FKAdd", myPartyID, "Driver", myUserID)

        End Sub

        Public Sub s_Job(ByVal myPartyID As String)

            Dim myCarrierPartyID As String = CarrierRCB.SelectedValue

            Dim myW As String = PartyCarrierTable.PartyID.UniqueName & " = " & myCarrierPartyID
            Dim myR As PartyCarrierRecord = PartyCarrierTable.GetRecord(myW)
            Dim myCarrierID As String = myR.CarrierID.ToString

            Dim myJobID As String = JobRCB.SelectedValue


            Dim myAdActivityID As String

            If String.IsNullOrEmpty(myCarrierID) = False And myCarrierID <> "0" And String.IsNullOrEmpty(myJobID) = False And myJobID <> "0" Then
                Try
                    DbUtils.StartTransaction()
                    Dim myRec As New CarrierAdActivityRecord
                    myRec.CarrierID = CInt(myCarrierID)
                    myRec.AdID = CInt(myJobID)
                    myRec.PartyID = CInt(myPartyID)
                    myRec.FlowStepID = 309
                    myRec.Save()
                    DbUtils.CommitTransaction()
                    myAdActivityID = myRec.AdActivityID.ToString
                ...
                Finally
                    ...
                    Dim myUserID As String = CType(Me.Page, BaseApplicationPage).SystemUtils.GetUserID()
                    Dim myExecutionID As String = CustGenClass.f_Sproc("usp_ExecutionAdd", myCarrierPartyID, "45", myUserID, myPartyID, "309")
                    Dim myInstanceID As String = CustGenClass.f_Sproc("usp_ThreadGetInstance", "CarrierAdActivity", "309", myAdActivityID)
                    Dim myAddrID As String = Nothing
                    s_ExecutionUpdates(myAdActivityID, myExecutionID, myPartyID, myInstanceID)
...
#Region "Section 2: Do not modify this section."
        ...
        Public WithEvents CarrierLbl As System.Web.UI.WebControls.Label
        Public WithEvents CarriersDS As System.Web.UI.WebControls.SqlDataSource
        Public WithEvents DirectDialLabel As System.Web.UI.WebControls.Label
        ...
        Public WithEvents emailValidator2 As System.Web.UI.WebControls.RequiredFieldValidator
        Public WithEvents FaxLabel As System.Web.UI.WebControls.Label
        Public WithEvents HandleLabel As System.Web.UI.WebControls.Label
        Public WithEvents JobLbl As System.Web.UI.WebControls.Label
        Public WithEvents JobsDS As System.Web.UI.WebControls.SqlDataSource
        Public WithEvents MobileLabel As System.Web.UI.WebControls.Label
        Public WithEvents NameLabel As System.Web.UI.WebControls.Label
        Public WithEvents NameValidator As System.Web.UI.WebControls.RequiredFieldValidator
        Public WithEvents OtherLabel As System.Web.UI.WebControls.Label
